 ...
 */
export const cleanupExpiredTempAssignments = functions
 ...
 * 테스트용으로 사용할 수 있음
 */
export const manualCleanupExpiredTempAssignments = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    const result = await cleanupExpiredTempAssignments(null)
    return result
  })
